...
const WorkshopFilters: React.FC<WorkshopFiltersProps> = ({
  ...
  return (
    <div className="lg:w-1/6 pl-2 lg:pl-0 pr-2 h-full lg:sticky lg:top-20 self-start">
      <h2 className="text-lg font-semibold text-gray-800 mb-4">{t('filters') || "Filters"}</h2>

      {/* Status Filter */}
      <div className="filter-group mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">{t('status') || "Status"}</h3>
      ...
      {/* Age Filter */}
      <div className="filter-group mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">{t('age') || "Age"}</h3>
        <div className="flex flex-wrap gap-1.5 max-w-[200px]">
      ...
      {/* Skill Level Filter */}
      <div className="filter-group mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">{t('skillLevel') || "Skill Level"}</h3>
        <div className="flex flex-wrap gap-1.5 max-w-[200px]">
      ...
      {/* Location Filter */}
      <div className="filter-group mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">{t('location') || "Location"}</h3>
        <div className="flex flex-wrap gap-1.5 max-w-[200px]">
      ...
      {/* Category Filter */}
      <div className="filter-group mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">{t('category') || "Category"}</h3>
      ...
      {/* Tech Type Filter */}
      <div className="filter-group mb-4">
        <h3 className="text-sm font-medium text-gray-700 mb-2">{t('techType') || "Tech Type"}</h3>
        <div className="flex flex-wrap gap-1.5 max-w-[180px]">
